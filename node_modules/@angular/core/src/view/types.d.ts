 ...
 * logs.
 */
export type DefinitionFactory<D extends Definition<any>> = (logger: NodeLogger) => D;
/**
 * Function to call console.error at the right source location. This is an indirection
 * via another function as browser will log the location that actually called
 * `console.error`.
 */
export type NodeLogger = () => () => void;
...
export type ViewHandleEventFn = (view: ViewData, nodeIndex: number, eventName: string, event: any) => boolean;
/**

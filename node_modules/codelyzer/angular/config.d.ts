...
export type StyleTransformer = (style: string, url?: string) => CodeWithSourceMap;
export type TemplateTransformer = (template: string, url?: string) => CodeWithSourceMap;
export type UrlResolver = (url: string | null) => string | null;

...
declare namespace postcss {
  ...
  type TransformCallback = (root: Root, result: Result) => Promise<any> | any;
  type PluginInitializer<T> = (pluginOptions?: T) => Transformer;
  /**
  ...
  export namespace Stringifier {
    type Builder = (str: string, node?: Node, str2?: string) => void;
  }
  /**
  ...
  type Parser = (css: string, opts?: Pick<ProcessOptions, 'map' |'from'>) => Root;
  type Stringifier = (node: Node, builder: Builder) => void;
  type Builder = (part: string, node?: Node, type?: 'start' | 'end') => void;
  /**
...
this;
    ...
    replaceValues(pattern: string | RegExp, options: {
         ...
         */
        fast?: string;
    },            callbackOrReplaceValue: string | ((substring: string, ...args: any[]) => string;)):     replaceValues(pattern: string | RegExp, callbackOrReplaceValue: string | ((substring: string, ...args: any[]) => string;)):     /**

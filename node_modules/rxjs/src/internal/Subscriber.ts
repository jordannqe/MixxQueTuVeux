...
export class Subscriber<T> extends Subscription implements Observer<T> {
      ...
      case 1:
        ...
        if (typeof destinationOrNext === 'object') {
          if (destinationOrNext instanceof Subscriber) {
            ...
            this.destination = new SafeSubscriber<T>(this, destinationOrNext as PartialObserver<any>);
          }
          break;
        }
      default:
        this.syncErrorThrowable = true;
        this.destination = new SafeSubscriber<T>(this, destinationOrNext as ((value: T) => void), error, complete);
        break;
    }
  }
  ...
  /** @internal */ syncErrorThrowable = false;
...
export class SafeSubscriber<T> extends Subscriber<T> {
  ...
  constructor(private _parentSubscriber: Subscriber<T>,
    ...
    if (isFunction(observerOrNext)) {
      ...
      next = (observerOrNext as PartialObserver<T>).next;

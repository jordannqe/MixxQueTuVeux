...
type ErrorEventHandler = (event: Event | string, source?: string, fileno?: number, columnNumber?: number, error?: Error) => void;

type EventHandlerNonNull = (event: Event) => any;

type ForEachCallback = (keyId: Int8Array | Int16Array | Int32Array | Uint8Array | Uint16Array | Uint32Array | Uint8ClampedArray | Float32Array | Float64Array | DataView | ArrayBuffer | null, status: MediaKeyStatus) => void;
...
type OnErrorEventHandlerNonNull = (event: Event | string, source?: string, lineno?: number, colno?: number, error?: any) => any;
...
type PositionErrorCallback = (positionError: PositionError) => void;
...
type ReadableByteStreamControllerCallback = (controller: ReadableByteStreamController) => void | PromiseLike<void>;

type ReadableStreamDefaultControllerCallback<R> = (controller: ReadableStreamDefaultController<R>) => void | PromiseLike<void>;

type ReadableStreamErrorCallback = (reason: any) => void | PromiseLike<void>;

    ...
    if (delegate) {
      ...
      prototype[name] = ((delegate: Function) => {
        const patched: any = function() {
          return delegate.apply(this, bindArguments(arguments as any, source + '.' + name));
        };
...
export function patchProperty(obj: any, prop: string, prototype?: any) {
  ...
  desc.get = function() {
    ...
    if (listener) {
      ...
      const value = originalDescGet && originalDescGet.call(this);
      if (value) {
...
export function patchClass(className: string) {
  ...
  _global[className] = function() {
    const a = bindArguments(arguments as any, className);
    switch (a.length) {
      case 0:
...
export function patchMacroTask(
  ...
  function scheduleTask(task: Task) {
    const data = task.data as MacroTaskMeta;

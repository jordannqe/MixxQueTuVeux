...
Zone.__load_patch('fakeasync', (global: any, Zone: ZoneType, api: _ZonePrivate) => {
  ...
  interface ProxyZoneSpec {
    setDelegate(delegateSpec: ZoneSpec): void; getDelegate(): ZoneSpec; resetDelegate(): void;
  }
  const ProxyZoneSpec: {assertPresent: () => ProxyZoneSpecget(): ProxyZoneSpec; } =
  ...
  (Zone as any)[api.symbol('fakeAsyncTest')] = {resetFakeAsyncZone, flushMicrotasks, discardPeriodicTasks, tick, flush, fakeAsync};
});

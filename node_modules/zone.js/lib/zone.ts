...
const Zone: ZoneType = (function(global: any) {
  ...
  class Zone implements AmbientZone {
    ...
    public wrap<T extends Function>(callback: T, source: string): T {
      ...
      return function() {
        return zone.runGuarded(_callback, (this as any), arguments as any, source);
      } as any as T;
    }
    ...
    scheduleTask(targetZone: Zone, task: Task): Task {
      ...
      if (this._scheduleTaskZS) {
        ...
        if (task.scheduleFn) {
          ...
          scheduleMicroTask(task as MicroTask);
        } else {
    ...
    constructor(
      ...
      if (type === eventTask && options && (options as any).useG) {
        ...
        this.invoke = function() {
          return ZoneTask.invokeTask.call(global, self, this, arguments as any);
        };
      }
    }
